function varargout = pft_WarnDlg(WarnString,DlgName,Replace)
...
WarnStringCell = pft_DialogCellstrHelper(WarnString);

handle = pft_MsgBox(WarnStringCell,DlgName,'warn',Replace);
