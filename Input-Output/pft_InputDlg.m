function Answer=pft_InputDlg(Prompt, Title, NumLines, DefAns, Resize)
...
set(InputFig,'Position',pft_GetNiceDialogLocation(FigPos,get(InputFig,'Units')));
...
pft_SetDefaultButton(InputFig, OKHandle);
