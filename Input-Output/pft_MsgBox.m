...
inputStr = varargin{1};
BodyTextString = pft_DialogCellstrHelper(inputStr);
...
OKXOffset=(FigWidth-OKWidth)/2;
DefFigPos(3:4)=[FigWidth FigHeight];
DefFigPos = pft_GetNiceDialogLocation(DefFigPos, get(figureHandle,'Units'));
...
pft_SetDefaultButton(figureHandle, OKHandle);
