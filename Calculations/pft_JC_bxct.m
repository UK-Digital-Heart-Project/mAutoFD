...
% Mysterious code left over from JC's time - I can't see what it does (PFT: 06/09/2019)
...
FileName = sprintf('Box-Count-Slice-%02d.csv', Slice);
...
FileName = sprintf('Polynomial-Fit-Slice-%02d.csv', Slice);
PathName = fullfile(OutputFolder, FileName);
...
FileName = sprintf('Box-Count-Plot-Slice-%02d-ED.png', Slice);
